...
class GeneralizedRCNN(nn.Module):
    ...
    def forward(self, images, targets=None, use_pseudo_labeling_weight='none', with_DA_ON=True, save_feats=True, contrast=True):
        """
        Arguments:
        ...
        if self.roi_heads:
            ...
            x, result, detector_losses, da_ins_feas, da_ins_labels, da_proposals = self.roi_heads(features, proposals, targets, \
                                                                                                  ...
                                                                                                  save_feats=save_feats, contrast=contrast)
