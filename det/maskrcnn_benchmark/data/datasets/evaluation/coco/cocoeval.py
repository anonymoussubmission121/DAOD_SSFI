...
class COCOeval:
    ...
    def __init__(self, cocoGt=None, cocoDt=None, iouType='segm', logger=None, num_classes=8, skip=[]):
        '''
    ...
    def _prepare(self):
        ...
        # print("get ann ids: " + str(self.cocoGt.getAnnIds(imgIds=p.imgIds, catIds=p.catIds)))
        # print("img ids: " + str(p.imgIds))
        # print("cat ids: " + str(p.catIds))
        # print(self.cocoGt)
        # with open("imgToAnns.txt", 'w') as file:
        #     file.write(str(self.cocoGt.imgToAnns))
        # with open("anns.txt", 'w') as file:
        #     file.write(str(self.cocoGt.anns))
        # print(self.cocoGt.imgToAnns)
        # print(self.cocoGt.anns)
        # for imgId in p.imgIds:
        #     print(imgId)
        # print(str(self.cocoGt.imgToAnns.keys()))
    ...
    def computeIoU(self, imgId, catId):
        ...
        # if imgId < 12:
        #     print("img id: " + str(imgId) + " cat id: " + str(catId))
        #     # print("gts: " + str(self._gts))
        #     print(self._dts.keys())
        #     print("gt: " + str(self._gts[imgId,catId]))
        #     print("dt: " + str(self._dts[imgId,catId]))
        ...
        #     print("Computing IOU for img: " + str(imgId) + " and category: " + str(catId))
        #     print(ious.shape)
        #     for i in range(ious.shape[0]):
        #         print("i: " + str(i) + " " + str(ious[i]))
    ...
    def summarize(self, output_dir):
        ...
        def _summarize( ap=1, iouThr=None, areaRng='all', maxDets=100 ):
            ...
            # log and print AP related stats 
            # print("s: " + str(s))
            if len(s[s>-1])==0:
                mean_s = -1
            else:
        ...
        def _summarizeDets():
            ...
            stats[6], _ = _summarize(0, maxDets=self.params.maxDets[0])
            ...
            stats[12], _ = _summarize(1, areaRng='eS', iouThr=.5, maxDets=self.params.maxDets[2])
            stats[13], _ = _summarize(1, areaRng='rS', iouThr=.5, maxDets=self.params.maxDets[2])
            stats[14], _ = _summarize(1, areaRng='gS', iouThr=.5, maxDets=self.params.maxDets[2])
            stats[15], _ = _summarize(1, areaRng='Normal', iouThr=.5, maxDets=self.params.maxDets[2])
            return stats
        def _summarizeKps():
            stats = np.zeros((10,))
...
class Params:
    ...
    def setDetParams(self):
        ...
        self.areaRngLbl = ['all', 'eS', 'rS', 'gS', 'Normal']
