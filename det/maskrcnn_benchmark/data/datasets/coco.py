...
class COCODataset(torchvision.datasets.coco.CocoDetection):
    def __init__(
        ...
        # print("img 0:" + str(self.get_img_info(0)))
        # img_id = self.id_to_img_map[0]
        # print("img 0, id " + str(img_id) + ": " + str(self.coco.loadImgs()))


    def __getitem__(self, idx):
        img, anno = super(COCODataset, self).__getitem__(idx)

        # save original img for visualization
        ori_img = img
        ...
        # print("coco dataloader img size: " + str(img.shape))

        return ori_img, img, target, idx
